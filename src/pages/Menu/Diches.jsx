...
const Diches = () => {
  ...
  return (
   <div>
    <div id="menu" className='menu max-w-[1640px] m-auto px-4 py-12 '>
       <div>
  <h1 className='text-black font-bold text-5xl text-center font-park-avenue mb-0'>
    Our Dishes
  </h1>
  <p className='font-semibold text-center pt-4 pb-10'>
